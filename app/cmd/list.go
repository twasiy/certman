...
type ListCmd struct {
	Cert ListCertCmd `cmd:"" help:"Lists all the Certitificates."`
...
func (lcc *ListCertCmd) Run(ctx context.Context, query base.Querier) error {
...
func (lkc *ListKeyCmd) Run(ctx context.Context, query base.Querier) error {
	var keys []string
	var err error
